 ...
 * 
 * Source file : ../../../sdios/src/root/logger.idl
 * Platform    : V4 Generic
 * Mapping     : CORBA C
 * 
...
long service_IF_LOGGING_LogMessage(L4_ThreadId_t _caller, _param_IF_LOGGING_LogMessage *_par);
...
//   R0: long _msgtag                 3    0    4    4 -p---  -1
//   R4: long _message_size           2    4    4    4 x----  -1
...
//   R-: long _msgtag                 4   -1    4    4 -p---  -1

#define IDL4_PUBLISH_IF_LOGGING_LOGMESSAGE(_func) long service_IF_LOGGING_LogMessage(L4_ThreadId_t _caller, _param_IF_LOGGING_LogMessage *_par)\
\
{ \
...
#define LOGGER_FID_MASK 0
#define LOGGER_IID_MASK 1
...
long service_logger_LogMessage(L4_ThreadId_t _caller, _param_logger_LogMessage *_par);
...
#define IDL4_PUBLISH_LOGGER_LOGMESSAGE(_func) long service_logger_LogMessage(L4_ThreadId_t _caller, _param_logger_LogMessage *_par)\
\
{ \
  idl4_server_environment _env; \
  CORBA_char *g1; \
